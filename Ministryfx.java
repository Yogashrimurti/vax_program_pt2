...
public class Ministryfx extends Application {
    ...
    class MinistryOfHealthLayout extends GridPane implements EventHandler<ActionEvent> {
        ...
        class VCTableLayout extends VBox {
            ...
            public VCTableLayout(ArrayList<VaccinationCenter> vcs) {
                ...
                tfNumOfRecp = new TextField();
                tfNumOfDose.setPromptText("Number of vaccines");
                tfNumOfRecp.setPromptText("Number of Recipients");
                ...
                HBox.setHgrow(tfNumOfRecp, Priority.ALWAYS);
                hBox.setPadding(new Insets(10, 10, 10, 10));
                hBox.setSpacing(10);
                hBox.getChildren().addAll(tfNumOfDose,tfNumOfRecp, btDistributeVaccine, btDistributeRecipient);
                ...
                TableColumn<VaccinationCenter, Integer> tblColRemainingRecipient = new TableColumn<>("Remaining Recipient");
                tblColRemainingRecipient.setMinWidth(100);
                //tblColRemainingRecipient.setCellValueFactory(new PropertyValueFactory<>("remainingRecipient"));

                tableViewVC = new TableView<>();
                tableViewVC.setItems(vcObservableList);
                tableViewVC.getColumns().addAll(tblColName, tblCapacityPerDay, tblColRemainingVaccine,tblColRemainingRecipient );
